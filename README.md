...
* Handling of incoming orders
    * Contains three sections
        1. **Pending Confirmation:** Once a new order arrives, it will come in this section, the owner would first have to accept an order or reject it selecting the proper reason.
        2. **Active Orders:** Once an order is accepted, it is brought to this section along the assignment of the order number. 
        3. **Ready Orders:** This section contains orders that are marked as prepared and are ready for pickup.
...
* Analytics Dashboard
    * The analytics section provides an owner with **three** important informations.
        1. **Revenue Generated:** This lets the owner know how much revenue was generated by an outlet on a given date, month or year.
        2. **Outlets comparison:** This lets the owner compare multiple outlets based on revenue generated on a given day, month or year.
        3. **Products comparison:** This lets the owner compare the performance of the various products of the outlet based on their quantity ordered on given day, month or year.
